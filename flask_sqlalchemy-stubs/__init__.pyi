...
class SignallingSession(SessionBase):
    app: Any = ...
    def __init__(self, db: SQLAlchemy, autocommit: bool = ..., autoflush: bool = ..., **options: Any) -> None: ...
    def get_bind(self, mapper: Optional[Mapper] = ..., clause: Optional[Select] = ...) -> Engine: ...
...
class _EngineConnector:
    def __init__(self, sa: SQLAlchemy, app: Flask, bind: Optional[str] = ...) -> None: ...
...
class SQLAlchemy:
    ...
    def make_declarative_base(self, model: _T, metadata: Optional[Any] = ...) -> _T: ...
    def init_app(self, app: Flask) -> None: ...
    def apply_pool_defaults(self, app: Flask, options: Dict[Any, Any]) -> None: ...
    def apply_driver_hacks(self, app: Flask, sa_url: URL, options: Dict[str, int]) -> None: ...
    @property
    def engine(self) -> Engine: ...
    def make_connector(self, app: Flask = ..., bind: Optional[str] = ...) -> _EngineConnector: ...
    def get_engine(self, app: Optional[Flask] = ..., bind: Optional[str] = ...) -> Engine: ...
